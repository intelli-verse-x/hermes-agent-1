...
export function ReviewPane() {
  ...
  return (
    <aside
      aria-label={c.review}
      className={cn(
        'before:pointer-events-none relative flex h-full w-full min-w-0 flex-col overflow-hidden border-(--ui-stroke-secondary) bg-(--ui-sidebar-surface-background) pt-[calc(var(--titlebar-height)+var(--top-nav-height,0px))] text-(--ui-text-tertiary)',
        panesFlipped
